		...
		protected internal override void Calculate(int index)
		{
			...
			if (index >= this.length)
			{
				if (this.style == IndicatorStyle.QuantStudio)
				{
					...
					{
						num = this.upTS[index - 1] * (double)this.length;
						num2 = this.downTS[index - 1] * (double)this.length;
				...
				else
				{
					...
					{
						num = this.upTS[index - 1] * (double)(this.length - 1);
						num2 = this.downTS[index - 1] * (double)(this.length - 1);
						double num4 = this.input[index, this.barData];
						double num3 = this.input[index - 1, this.barData];
						if (num4 > num3)
						{
